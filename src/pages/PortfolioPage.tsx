...
export const PortfolioPage: React.FC<PortfolioPageProps> = ({ onSelectProject }) => {
  ...
  return (
    <div className="pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-10 sm:space-y-12 bg-[#FAF9F6] text-[#353535]">
      ...
      <div className="space-y-3 max-w-3xl">
        ...
        <p className="text-base text-[#353535]/75 leading-relaxed font-light">
          A complete collection of 16 commercial productions, wedding films, and editorial edits. Select any category to view individual projects.
        </p>
      </div>
        ...
        {MAIN_PORTFOLIO_CATEGORIES.map((cat, index) => {
          ...
          return (
            <motion.div
              ...
              id={`portfolio-cat-card-${cat.number}`}
            >
              ...
              <AnimatePresence initial={false}>
                {isExpanded && (
                  <motion.div
                    key={`portfolio-content-${cat.name}`}
